...
<a class="nav-link nav-icon" href="#" data-bs-toggle="dropdown">
  ...
  <?php
      ...
      $select ="SELECT COUNT(*)AS notify FROM `notifications` WHERE `target_role`='teacher' ";
...
<?php }?>
    ...
    <?php
            ...
            $select ="SELECT * FROM `teacher` WHERE `email` ='$userid'";
            $query = mysqli_query($conn,$select);
...
<ul class="sidebar-nav" id="sidebar-nav">
  ...
  <li class="nav-item">
        <a class="nav-link" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#" aria-expanded="true">
          <i class="bi bi-menu-button-wide"></i><span>Club</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="components-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav" style="">
          <li>
            <a href="club.php">
              <i class="bi bi-circle"></i><span>Create Club</span>
            </a>
          </li>
          <li>
            <a href="add_score.php">
              <i class="bi bi-circle"></i><span>Add Score</span>
            </a>
          </li>
          <li>
            <a href="coming.php">
              <i class="bi bi-circle"></i><span>Club Request</span>
            </a>
          </li>
